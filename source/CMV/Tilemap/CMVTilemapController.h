...
//  Version: 1/5/23.
//
#ifndef __CMV_TILEMAP_CONTROLLER_H__
#define __CMV_TILEMAP_CONTROLLER_H__

// This is in the same directory
#include "CMVTilemapModel.h"
// This is NOT in the same directory
#include <CMV/Tile/CMVTileController.h>

namespace CMV {

/**
 * A class updating the model. It controls the entire tile map.
 */
...
#endif /* __CMV_TILEMAP_CONTROLLER_H__ */
